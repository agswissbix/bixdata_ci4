...
<body>
    ...
    <div class="wrapper">
        ...
        <!-- ========== Topbar Start ========== -->
        <div class="bar">
            <div class="navbar-custom topnav-navbar" style="margin-left: 255px">
        ...
        <!-- ========== Left Sidebar Start ========== -->
        <div class="bar">
            <div class="leftside-menu" style="margin-top: -5px; margin-left: -36px">
                ...
                <div class="h-100" id="leftside-menu-container" data-simplebar>
                    ...
                    <!-- Logo light -->
                    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html" style="margin-top: 30px; margin-bottom: 20px; text-align: center">
