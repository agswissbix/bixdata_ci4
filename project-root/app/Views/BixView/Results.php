    ...
    <table class="table">
        <thead>
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <button class="btn btn-primary me-md-2 shadow" type="button">Refresh</button>
...
<div class="shadow p-3 mb-5 bg-body rounded">
<button type="button" class="btn btn-primary"><i class="bi bi-android2"></i> Primary</button>
